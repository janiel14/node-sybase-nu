...
public class SybaseDB {
	...
	{
		this(host, port, dbname, username, password, "utf8", new Properties());
	}
	public SybaseDB(String host, Integer port, String dbname, String username, String password, String charset, Properties props)
	{
		this.host = host;
		this.port = port;
		this.dbname = dbname;
		...
		this.props.put("password", password);
                this.props.put("chartset", charset);
